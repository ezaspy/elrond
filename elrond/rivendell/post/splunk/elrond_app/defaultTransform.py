...
def create_transforms_conf(transformsconf):
    ...
    assignment_pairings = {
        ...
        "Artefact_|_\\.7z|\\.arj|\\.tar|\\.tgz|\\.zip": "T1560.001 - Archive via Utility",  # timeline
        ...
        "Artefact_|_contentsofdirectoryatpath|pathextension|fork |fork_": "T1106.000 - Native API",  # timeline
        "Artefact_|_csc\\.exe|gcc |gcc_": "T1027.004 - Compile After Delivery",  # timeline
        "Artefact_|_cscript|pubprn": "T1216.001 - PubPrn",  # timeline
        "Artefact_|_curl |curl_|wget |wget_": "T1048.003 - Exfiltration over Unencrypted/Obfuscated Non-C2 Protocol | T1553.001 - Gatekeeper Bypass",  # timeline
        ...
        "Artefact_|_ping\\.|ping |traceroute|dig |etc/host|etc/hosts|bonjour": "T1016.001 - Internet Connection Discovery | T1018.000 - Remote System Discovery",  # timeline
        ...
        "Filename_|_etc/passwd|etc/shadow": "T1003.008 - /etc/passwd and /etc/shadow | T1087.001 - Local Account | T1556.003 - Pluggable Authentication Modules",  # LastAccessTime, metadata & iocs
        ...
        "Message_|_/etc/profile|/etc/zshenv|/etc/zprofile|/etc/zlogin": "T1546.004 - Unix Shell Configuration Modification",  # unix-logs, timeline
        ...
        "Message_|_\\.mp3|\\.wav|\\.aac|\\.m4a": "T1123.000 - Audio Capture",  # unix-logs, timeline
        "Message_|_\\.mp4|\\.mkv|\\.avi|\\.mov|\\.wmv|\\.mpg|\\.mpeg|\\.m4v|\\.flv": "T1125.000 - Video Capture",  # unix-logs, timeline
        "Message_|_\\.msg|\\.eml": "T1203.000 - Exploitation for Client Execution | T1204.001 - Malicious Link | T1204.002 - Malicious File | T1566.001 - Spearphishing Attachment | T1566.002 - Spearphishing Link",  # unix-logs, timeline
        "Message_|_\\.local|\\.manifest": "T1574.001 - DLL Search Order Hijacking",  # unix-logs, timeline
        "Message_|_\\.ost|\\.pst|\\.msg|\\.eml": "T1114.001 - Local Email Collection",  # unix-logs, timeline
        ...
        "Message_|_at\\.": "T1053.001 - At (Linux) | T1053.002 - At (Windows)",  # unix-logs, timeline
        ...
        "Message_|_com\\.apple\\.quarantine": "T1553.001 - Gatekeeper Bypass",  # unix-logs, timeline
        ...
        "Message_|_emond": "T1546.014 - Emond | T1547.011 - Plist Modification",  # unix-logs, timeline
        ...
        "Message_|_hidden": "T1564.003 - Hidden Window",  # unix-logs, timeline
        ...
        "Message_|_loginitems|loginwindow|smloginitemsetenabled|uielement|quarantine": "T1547.011 - Plist Modification",  # unix-logs, timeline
        ...
        "Message_|_rm -|rm_-": "T1070.004 - File Deletion | T1485.000 - Data Destruction",  # unix-logs, timeline
        ...
        "Message_|_xattr|xttr": "T1553.001 - Gatekeeper Bypass",  # unix-logs, timeline
        ...
        "nixCommand_|_ifconfig|dig ": "T1016.001 - Internet Connection Discovery",  # memory, unix-logs
        ...
        "nixCommand_|_ping\\.|ping |traceroute|dig |etc/host|etc/hosts|bonjour": "T1016.001 - Internet Connection Discovery | T1018.000 - Remote System Discovery",  # memory, unix-logs
        ...
        "nixCommand_|_startupparameters": "T1037.002 - Logon Script (Mac) | T1037.005 - Startup Items | T1547.011 - Plist Modification",  # memory, unix-logs
        ...
        "nixProcess_|_\\.mobileconfig|profiles": "T1176.000 - Browser Extensions",  # unix-logs, timeline
        ...
        "nixProcess_|_is_debugging|sysctl|ptrace": "T1497.001 - System Checks",  # unix-logs, timeline
        "nixProcess_|_keychain": "T1555.001 - Keychain",  # unix-logs, timeline
        "nixProcess_|_launchagents": "T1543.001 - Launch Agent",  # unix-logs, timeline
        "nixProcess_|_launchctl": "T1569.001 - Launchctl",  # unix-logs, timeline
        "nixProcess_|_launchdaemons": "T1543.004 - Launch Daemon",  # unix-logs, timeline
        "nixProcess_|_loginitems|loginwindow|smloginitemsetenabled|uielement|quarantine": "T1547.011 - Plist Modification",  # unix-logs, timeline
        ...
        "nixProcess_|_rc\\.local|rc\\.common": "T1037.004 - RC Scripts",  # unix-logs, timeline
        ...
        "nixProcess_|_startupitems": "T1037.002 - Logon Script (Mac)",  # unix-logs, timeline
        "nixProcess_|_startupparameters": "T1037.002 - Logon Script (Mac) | T1037.005 - Startup Items | T1547.011 - Plist Modification",  # unix-logs, timeline
        "nixProcess_|_sudo|timestamp_timeout|tty_tickets": "T1548.003 - Sudo and Sudo Caching",  # unix-logs, timeline
        "nixProcess_|_systemctl": "T1543.001 - Launch Agent",  # unix-logs, timeline
        "nixProcess_|_systemsetup": "T1082.000 - System Information Discovery",  # unix-logs, timeline
        "nixProcess_|_time|sleep": "T1497.003 - Time Based Evasion",  # unix-logs, timeline
        "nixProcess_|_timer": "T1053.006 - Systemd Timers",  # memory, unix-logs
        "nixProcess_|_trap": "T1546.005 - Trap",  # unix-logs, timeline
        "nixProcess_|_uielement": "T1564.003 - Hidden Window",  # unix-logs, timeline
        ...
        "nixProcess_|_xattr|xttr": "T1553.001 - Gatekeeper Bypass",  # unix-logs, timeline
        "nixProcess_|_xdg|autostart": "T1547.013 - XDG Autostart Entries",  # unix-logs, timeline
        "nixProcess_|_xwd|screencapture": "T1113.000 - Screen Capture",  # unix-logs, timeline
        ...
        "Plist_|_startupparameters": "T1037.002 - Logon Script (Mac) | T1037.005 - Startup Items | T1547.011 - Plist Modification",  # plists
        ...
        "WinCommand_|_ifconfig|dig ": "T1016.001 - Internet Connection Discovery",  # memory, evt
        ...
        "WinCommand_|_ping\\.|ping |tracert|dig ": "T1016.001 - Internet Connection Discovery | T1018.000 - Remote System Discovery",  # memory, evt
