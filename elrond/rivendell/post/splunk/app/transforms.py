...
def create_transforms(transformsconf):
    ...
    assignment_pairings = {
        ...
        "Artefact_|_lsof|route": "T1049.000 - System Network Connections Discovery",  # usb, timeline
        ...
        "Artefact_|_ping\\.|ping |traceroute|ifconfig|ipconfig|dig |etc/host|etc/hosts|bonjour": "T1016.001 - Internet Connection Discovery | T1018.000 - Remote System Discovery",  # usb, timeline
        ...
        "Message_|_lsof|route": "T1049.000 - System Network Connections Discovery",  # unix-logs, timeline
        ...
        "Message_|_ping\\.|ping |traceroute|ifconfig|dig |etc/host|etc/hosts|bonjour": "T1016.001 - Internet Connection Discovery | T1018.000 - Remote System Discovery",  # unix-logs, timeline
        ...
        "nixCommand_|_contentsofdirectoryatpath|pathextension|fork |fork_": "T1106.000 - Native API",  # memory, unix-logs
        "nixCommand_|_csrutil": "T1553.006 - Code Signing Policy Modification",  # memory, unix-logs
        "nixCommand_|_curl |curl_|wget |wget_": "T1048.003 - Exfiltration over Unencrypted/Obfuscated Non-C2 Protocol | T1553.001 - Gatekeeper Bypass",  # memory, unix-logs
        "nixCommand_|_discover|offer|request": "T1557.003 - DHCP Spoofing",  # memory, unix-logs
        ...
        "nixCommand_|_emond": "T1546.014 - Emond | T1547.015 - Login Items",  # memory, unix-logs
        ...
        "nixCommand_|_git ": "T1213.003 - Code Repositories | T1567.001 - Exfiltration to Code Repository",  # memory, unix-logs
        ...
        "nixCommand_|_is_debugging|sysctl|ptrace": "T1497.001 - System Checks | T1622 - Debugger Evasion",  # memory, unix-logs
        ...
        "nixCommand_|_lsof|route": "T1049.000 - System Network Connections Discovery",  # memory, unix-logs
        ...
        "nixCommand_|_mssaveblob": "T1027.006 - HTML Smuggling",  # memory, unix-logs
        "nixCommand_|_nsxpcconnection": "T1559.003 - XPC Services",  # memory, unix-logs
        "nixCommand_|_onedrive|1drv|azure|icloud|cloudrive|dropbox|drive\\.google|\\.box\\.com|egnyte|mediafire|zippyshare|megaupload|4shared": "T1537.000 - Transfer Data to Cloud Account | T1567.002 - Exfiltration to Cloud Storage",  # memory, unix-logs
        ...
        "nixCommand_|_ping\\.|ping |traceroute|ifconfig|dig |etc/host|etc/hosts|bonjour": "T1016.001 - Internet Connection Discovery | T1018.000 - Remote System Discovery",  # memory, unix-logs
        "nixCommand_|_plutil|lsuielement|lsenvironment|dfbundledisplayname|cfbundleidentifier": "T1647 - Plist File Modification",  # memory, unix-logs
        ...
        "nixCommand_|_ps -|ps  -|ps_-": "T1057.000 - Process Discovery",  # memory, unix-logs
        ...
        "nixCommand_|_rm -|rm  -|rm_-": "T1070.004 - File Deletion | T1485.000 - Data Destruction",  # memory, unix-logs
        ...
        "nixCommand_|_startupitems": "T1037.002 - Logon Script (Mac)",  # unix-logs, timeline
        "nixCommand_|_startupparameters": "T1037.002 - Logon Script (Mac) | T1037.005 - Startup Items | T1547.015 - Login Items",  # memory, unix-logs
        ...
        "nixCommand_|_time|sleep": "T1497.003 - Time Based Evasion | T1053.006 - Systemd Timers",  # memory, unix-logs
        ...
        "nixCommand_|_xattr|xttr": "T1553.001 - Gatekeeper Bypass | T1564.009 - Resource Forking",  # memory, unix-logs
        ...
        "nixProcess_|_\\.mobileconfig|profiles": "T1176.000 - Browser Extensions",  # memory, unix-logs
        "nixProcess_|_bluetooth": "T1011.001 - Exfiltration over Bluetooth",  # memory, unix-logs
        "nixProcess_|_csrutil": "T1553.006 - Code Signing Policy Modification",  # memory, unix-logs
        "nixProcess_|_discover|offer|request": "T1557.003 - DHCP Spoofing",  # memory, unix-logs
        "nixProcess_|_fsutil|fsinfo": "T1120.000 - Peripheral Device Discovery",  # memory, unix-logs
        "nixProcess_|_git ": "T1213.003 - Code Repositories | T1567.001 - Exfiltration to Code Repository",  # memory, unix-logs
        "nixProcess_|_is_debugging|sysctl|ptrace": "T1497.001 - System Checks | T1622 - Debugger Evasion",  # memory, unix-logs
        "nixProcess_|_keychain": "T1555.001 - Keychain",  # memory, unix-logs
        "nixProcess_|_launchagents": "T1543.001 - Launch Agent",  # memory, unix-logs
        "nixProcess_|_launchctl": "T1569.001 - Launchctl",  # memory, unix-logs
        "nixProcess_|_launchdaemons": "T1543.004 - Launch Daemon",  # memory, unix-logs
        "nixProcess_|_loginitems|loginwindow|smloginitemsetenabled|uielement|quarantine": "T1547.015 - Login Items",  # memory, unix-logs
        "nixProcess_|_malloc|ptrace_setregs|ptrace_poketext|ptrace_pokedata": "T1055.008 - Ptrace System Calls",  # memory, unix-logs
        "nixProcess_|_microphone": "T1123.000 - Audio Capture",  # memory, unix-logs
        "nixProcess_|_modprobe|insmod|lsmod|rmmod|modinfo|kextload|kextunload|autostart": "T1547.006 - Kernel Modules and Extensions",  # memory, unix-logs
        "nixProcess_|_mssaveblob": "T1027.006 - HTML Smuggling",  # memory, unix-logs
        "nixProcess_|_nsxpcconnection": "T1559.003 - XPC Services",  # memory, unix-logs
        "nixProcess_|_onedrive|1drv|azure|icloud|cloudrive|dropbox|drive\\.google|\\.box\\.com|egnyte|mediafire|zippyshare|megaupload|4shared": "T1537.000 - Transfer Data to Cloud Account | T1567.002 - Exfiltration to Cloud Storage",  # memory
        "nixProcess_|_pam_unix\\.so": "T1556.003 - Pluggable Authentication Modules",  # memory, unix-logs
        "nixProcess_|_ping\\.|ping |traceroute|dig |etc/host|etc/hosts|bonjour": "T1016.001 - Internet Connection Discovery | T1018.000 - Remote System Discovery",  # memory, unix-logs
        "nixProcess_|_plutil|lsuielement|lsenvironment|dfbundledisplayname|cfbundleidentifier": "T1647 - Plist File Modification",  # memory, unix-logs
        "nixProcess_|_python|\\.py |\\.py_": "T1059.006 - Python",  # memory, unix-logs
        "nixProcess_|_rc\\.local|rc\\.common": "T1037.004 - RC Scripts",  # memory, unix-logs
        ...
        "nixProcess_|_startupitems": "T1037.002 - Logon Script (Mac)",  # memory, unix-logs
        "nixProcess_|_startupparameters": "T1037.002 - Logon Script (Mac) | T1037.005 - Startup Items | T1547.015 - Login Items",  # memory, unix-logs
        "nixProcess_|_sudo|timestamp_timeout|tty_tickets": "T1548.003 - Sudo and Sudo Caching",  # memory, unix-logs
        "nixProcess_|_systemctl": "T1543.001 - Launch Agent",  # memory, unix-logs
        "nixProcess_|_systemsetup": "T1082.000 - System Information Discovery",  # memory, unix-logs
        "nixProcess_|_time|sleep": "T1497.003 - Time Based Evasion | T1053.006 - Systemd Timers",  # memory, unix-logs
        "nixProcess_|_trap": "T1546.005 - Trap",  # memory, unix-logs
        "nixProcess_|_uielement": "T1564.003 - Hidden Window",  # memory, unix-logs
        ...
        "nixProcess_|_xattr|xttr": "T1553.001 - Gatekeeper Bypass | T1564.009 - Resource Forking",  # memory, unix-logs
        "nixProcess_|_xdg|autostart": "T1547.013 - XDG Autostart Entries",  # memory, unix-logs
        "nixProcess_|_xwd|screencapture": "T1113.000 - Screen Capture",  # memory, unix-logs
        "WinCommand_|_ winword| excel| powerpnt| acrobat| acrord32|winword\\.|excel\\.|powerpnt\\.|acrobat\\.|acrord32\\.": "T1203.000 - Exploitation for Client Execution | T1204.002 - Malicious File",  # memory, evt
        ...
        "WinCommand_|_\\.7z|\\.arj|\\.tar|\\.tgz|\\.zip|winzip|winrar": "T1560.001 - Archive via Utility",  # memory, evt
        ...
        "WinCommand_|_allowreversiblepasswordencryption|userparameters|set-adaccountcontrol": "T1556.005 - Reversible Encryption",  # memory, evt
        "WinCommand_|_ascii|unicode|hex|base64|mime": "T1132.001 - Standard Encoding",  # memory, evt
        "WinCommand_|_at\\.": "T1053.002 - At",  # memory, evt
        ...
        "WinCommand_|_bcdedit": "T1490.000 - Inhibit System Recovery | T1553.006 - Code Signing Policy Modification | T1562.009 - Safe Mode Boot",  # journal
        "WinCommand_|_beingdebugged": "T1622 - Debugger Evasion",  # memory, evt
        "WinCommand_|_bluetooth": "T1011.001 - Exfiltration over Bluetooth",  # memory, evt
        "WinCommand_|_bootcfg": "T1562.009 - Safe Mode Boot",  # journal
        ...
        "WinCommand_|_createthread": "T1055.013 - Process Doppelganging | T1620 - Reflective Code Loading",  # memory, evt
        ...
        "WinCommand_|_curl |curl_|wget |wget_": "T1048.003 - Exfiltration over Unencrypted/Obfuscated Non-C2 Protocol | T1553.001 - Gatekeeper Bypass",  # memory, evt
        ...
        "WinCommand_|_discover|offer|request": "T1557.003 - DHCP Spoofing",  # memory, evt
        ...
        "WinCommand_|_engineversion": "T1562.010 - Downgrade Attack",  # memory, evt
        "WinCommand_|_eventvwr|sdclt": "T1548.002 - Bypass User Account Control",  # memory, evt
        "WinCommand_|_execute-assembly|nscreateobjectfileimagefrommemory|memfd_create|execve": "T1620 - Reflective Code Loading",  # memory, evt
        ...
        "WinCommand_|_g_cioptions|requiresigned": "T1553.006 - Code Signing Policy Modification",  # memory, evt
        ...
        "WinCommand_|_getuserdefaultuilanguage|getsystemdefaultuilanguage|getkeyboardlayoutlist|getuserdefaultlangid|gettextcharset|getlocaleinfoa": "T1614.001 - System Language Discovery",  # memory, evt
        "WinCommand_|_getwindowlong|setwindowlong": "T1055.011 - Extra Window Memory Injection",  # memory, evt
        "WinCommand_|_git ": "T1213.003 - Code Repositories | T1567.001 - Exfiltration to Code Repository",  # memory, evt
        "WinCommand_|_github|gitlab|bitbucket": "T1567.001 - Exfiltration to Code Repository",  # memory, evt
        "WinCommand_|_gpresult|get-domaingpo": "T1615 - Group Policy Discovery",  # memory, evt
        ...
        "WinCommand_|_isdebuggerpresent|ntqueryinformationprocess|outputdebugstring": "T1106.000 - Native API | T1622 - Debugger Evasion",  # memory, evt
        "WinCommand_|_itaskservice|itaskdefinition|itasksettings": "T1559.001 - Component Object Model Hijacking",  # memory, evt
        "WinCommand_|_kernelcallbacktable|fncopydata|fndword": "T1574.013 - KernelCallbackTable",  # memory, evt
        ...
        "WinCommand_|_mavinject|injectrunning": "T1218.013 - Mavinject",  # memory, evt
        ...
        "WinCommand_|_mmc ": "T1564.008 - Email Hiding Rules",  # memory, evt
        ...
        "WinCommand_|_mssaveblob": "T1027.006 - HTML Smuggling",  # memory, evt
        ...
        "WinCommand_|_new-inboxrule|set-inboxrule": "T1564.008 - Email Hiding Rules",  # memory, evt
        ...
        "WinCommand_|_onedrive|1drv|azure|icloud|cloudrive|dropbox|drive\\.google|\\.box\\.com|egnyte|mediafire|zippyshare|megaupload|4shared": "T1537.000 - Transfer Data to Cloud Account | T1567.002 - Exfiltration to Cloud Storage",  # memory, evt
        ...
        "WinCommand_|_ping\\.|ping |tracert|ipconfig|dig ": "T1016.001 - Internet Connection Discovery | T1018.000 - Remote System Discovery",  # memory, evt
        ...
        "WinCommand_|_registermodule": "T1505.004 - IIS Components",  # memory, evt
        ...
        "WinCommand_|_rundll32": "T1036.003 - Rename System Utilities | T1218.010 - Regsvr32 | T1218.011 - Rundll32",  # memory, evt
        "WinCommand_|_cplapplet|dllentrypoint|control_rundll|controlrundllasuser": "T1036.003 - Rename System Utilities | T1218.011 - Rundll32",  # memory, evt
        ...
        "WinCommand_|_set-casmailbox": "T1098.005 - Device Registration",  # memory, evt
        ...
        "WinCommand_|_syslistview32|findwindow|enumwindows|postmessage|sendmessage|lvm_sortitems": "T1055.015 - ListPlanting",  # memory, evt
        ...
        "WinCommand_|_termsrv ": "T1505.005 - Terminal Services DLL",  # memory, evt
        ...
        "WinCommand_|_vssadmin|wbadmin|shadows|shadowcopy": "T1490.000 - Inhibit System Recovery | T1553.006 - Code Signing Policy Modification",  # memory, evt
    ...
    transformsconf.write(
        parenthesis + 'mitre_technique=split(mitre_techniques," | ")\n\n'
    )
