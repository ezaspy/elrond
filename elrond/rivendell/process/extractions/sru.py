# Original form Source: https://github.com/MarkBaggett/srum-dump
...
parser.add_argument("--XLSX_TEMPLATE" ,"-t", default="/opt/elrond/elrond/tools/.SRUM_TEMPLATE3.xlsx", help="The Excel Template that specifies what data to extract from the srum database. You can create template_tables with ese_template.py.")
